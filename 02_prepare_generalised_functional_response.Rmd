...
data <- unnest(data,
               cols = "data_summary")
# write file
fwrite(data, file = "data/results/data_funresp_agents.csv")
```
...
# write to file
fwrite(data_plot, file = "data/results/data_funresp_strategy.csv")
```
...
# write 
fwrite(data_plot, file = "data/results/data_funresp_predators_items.csv")
```
