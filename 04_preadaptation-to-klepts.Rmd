...
```{r}
# read back in
data <- fread("data/results/data_early_0_100_weight_evolution.csv")

# select growth rates of 0.001, 0.01, 0.1, 0.25
focus_r = c(0.001, 0.01, 0.1, 0.25)
...
figure_3 =
  wrap_plots(subplots_fig3[c("obligate", "random", "facultative")])+
    plot_annotation(
      tag_levels = "a",
      tag_prefix = "(",
      tag_suffix = ")"
