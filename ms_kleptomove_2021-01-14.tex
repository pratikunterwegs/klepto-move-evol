...
\subsubsection{Movement-Behaviour Co-Evolution with Exploitative Competition}

\subsubsection{Movement-Behaviour Co-Evolution with Kleptoparasitism}
...
This is often achieved by finding the aggregative response of individuals to a relatively static indicator of landscape quality; i.e., how many individuals are present on patches or areas with different resource levels.
We examined the aggregative response of individuals in our simulations in relation to landscape productivity, to compare and contrast with predictions from optimal foraging theory \citep[][; see Fig. 5]{meer1997}.
%%
...
% \subsection{Spatial Distribution of Predators and Prey}

% \subsubsection{Individual Distributions}
...
% \subsubsection{Consequences for Prey Item Distribution}
