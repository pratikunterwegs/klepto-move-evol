...
weight_summary_move <- split(weight_summary_move, by = "sim_type")

# arrange in list
weight_summary_move <- weight_summary_move[c("foragers", "obligate", "facultative")]
...
ggsave(fig_node_weight_end,
       filename = "figures/fig_node_weight__move_end.png",
...
weight_summary_strategy[, sim_type := factor(sim_type,
                                    levels = c("foragers",
                                               ...
                                               "facultative"))]
# split for better vis
weight_summary_strategy <- split(weight_summary_strategy, by = "sim_type")

# arrange in list
weight_summary_strategy <- weight_summary_strategy[c("foragers", "obligate", "facultative")]
...
# save
ggsave(fig_node_weight_strategy_end,
       filename = "figures/fig_node_weight_strategy_end.png",
       dpi = 300, height = 120, width = 90, units = "mm")
```
