...
\subsection*{Individuals Use Indirect Cues to Climb Resource Gradients}
...
Kleptoparasites evolve when allowed to do so --- kleptoparasite intake depends only on the number of individuals --- kleptoparasite intake is highest when cells have few kleptoparasites and many producers
