...
# Plot sparse full sim node weight evolution data
...
plots <- Map(function(le) {
  ...
  subfigures <- lapply(le, function(df) {
    ...
    ggplot(df) +
      ...
      scale_fill_gradientn(
        colours = rev(pals::kovesi.linear_bmy_10_95_c78(10)),
        limits = c(1e-2, 1),
        na.value = NA
      ) +
  ...
  filename <- sprintf(
    "figures/fig_node_weight_%s.png",
    fig_name
  )
  message(fig_name)
  ggsave(figure,
